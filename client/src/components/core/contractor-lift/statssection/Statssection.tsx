...
const STATS = [
  { number: 100, suffix: "+", label: "Commercial Lift Projects" },
  { number: 500, suffix: "+", label: "Custom Design Options" },
  { number: 15, suffix: "+", label: "Trusted Industry Partners" },
  ...
  return (
    <section ref={sectionRef} className={styles.wrapper}>
      ...
      <div className={styles.left}>
        ...
        Reliable elevator solutions designed for modern commercial projects across the UAE.
        </p>
      </div>
