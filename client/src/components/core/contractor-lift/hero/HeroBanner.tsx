...
function CyclingTitle({
  staticLine = "Premium Elevator Solutions for Builders & Contractors in UAE",
  words = CYCLING_WORDS,
}: CyclingTitleProps) {
...
// comment all about cyclict text(leave staticline i want it) and code still working(dont delete just comment out)