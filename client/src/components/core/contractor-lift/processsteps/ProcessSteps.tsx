...
const STEPS_DEFAULT = [
    ...
    },
    {
        number: "05",
        title: "Installation",
        description: "Our certified engineers install your elevator with minimal disruption, fully tested and ready to use.",
        icon: (
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
...
export default function ProcessSteps({ data }: ProcessStepsProps) {
    ...
    const subheading = data?.subheading ?? "From consultation to installation — seamless lift solutions.";
