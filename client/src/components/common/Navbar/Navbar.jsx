    ...
    return (
        <>
            ...
            <header className={styles.topBar}>
                ...
                <Image width={100} height={100} src='/logo-invent-png-without-bg-1.png' alt="Invent Elevators" style={{height: '70px', objectFit: 'cover', width: 'auto', filter: 'brightness(0) invert(1)', marginLeft: '0rem'}}/>
                </Link>
