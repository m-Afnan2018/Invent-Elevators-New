...
export default async function ProductDetailPage({ params }) {
  ...
  try {
    product = await getProductBySlug(resolvedParams?.id);
  } catch (_error) {
    product = null;
  }
  ...
  return (
    <>
      ...
      <div id="overview"><ProductOverview product={product} /></div>
      <div id="specs"><ProductSpecs product={product} /></div>
      <div id="components"><ProductComponents product={product} /></div>
      <div id="testimonials"><ProductTestimonials product={product} /></div>
      <div id="quote"><ProductCTA product={product} /></div>
    </>
  );
}
