...
export default function CookiesPage() {
  ...
  return (
    <div className={styles.page}>
      <PageHero
        image={banner?.image}
        fallbackImage="/projects/city-centre.png"
        eyebrow="Legal"
      ...
      <div className={styles.hero} style={{ backgroundImage: banner?.image ? `url(${banner.image})` : undefined, backgroundSize: 'cover', backgroundPosition: 'center' }}>
        ...
        <div className={styles.heroInner} style={{ position:'relative',zIndex:1 }}>
          <p className={styles.eyebrow}>Legal</p><h1 className={styles.heroTitle}>Cookies Policy</h1><p className={styles.heroMeta}>Last updated: June 2026</p>
        </div>
      </div>
      ── END OLD hero ── */}
