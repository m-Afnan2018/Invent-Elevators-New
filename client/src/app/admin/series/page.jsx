        ...
        <div className={styles.overlay} onClick={closeEdit}>
          <div className={styles.modal} onClick={e => e.stopPropagation()}>
            ...
            <div className={styles.modalBody}>
              ...
              {activeTab === 'finishes' && (
                <div className={styles.fields}>
                  <p className={styles.hint}>Upload an image for each finish (e.g. material swatch or texture photo).</p>
                  {(form.finishes||[]).map((f,i)=>(
                    <div key={i} className={styles.block}>
                      <div className={styles.row2}>
                        <input value={f.name||''} onChange={e=>setItem('finishes',i,'name',e.target.value)} placeholder="Finish name (e.g. Silver Satin)" />
                  ...
                  <button className={styles.addBtn} onClick={()=>addItem('finishes',{name:'',image:''})}><RiAddLine /> Add Finish</button>
                </div>
              )}
